...
Also added a divider before new custom values in FilterListBox when there are other filtered items visible, to visually separate them from existing options.
