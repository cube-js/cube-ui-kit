...
`Root` installs the design tokens and providers used by overlays, navigation, internationalization, and other shared behaviors. See the [Root reference](/docs/getting-started-root--docs) for application-level options.
...
For component states, reusable styled components, sub-elements, presets, and the complete token reference, continue to [Usage](/docs/getting-started-usage--docs) or the [Tasty project](https://tasty.style).
...
The [Theming guide](/docs/getting-started-theming--docs) covers palette zones, runtime updates, regional previews, dark mode, and high-contrast behavior.
...
- Review [Base Properties](/docs/getting-started-base-properties--docs) shared by components across the kit.
