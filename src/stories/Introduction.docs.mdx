...
2. **Learn Tasty** - Visit the [Tasty documentation](/docs/tasty) to master the styling system
3. **Build Forms** - Check out [Form documentation](/docs/form) for form development patterns
