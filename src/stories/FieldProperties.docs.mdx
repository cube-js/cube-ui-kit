...
- **`dependsOn`** `readonly FormPath[]` — Explicit modern field dependencies. Validator reads also track dependencies automatically.
- **`rulesKey`** `string` — Explicit modern validator revision, checked alongside structural rule constraints.
