...
```jsx live=false
<Layout height="400px">
  <Layout.Panel side="left" size={200} isOpen={isOpen}>
...
```jsx live=false
<Layout.Toolbar>
  <Title level={4}>App Name</Title>      {/* Left */}
  <Button type="primary">Action</Button> {/* Right */}
</Layout.Toolbar>
```
...
<Layout.Toolbar>
  ...
  <Title level={4}>Page Title</Title>   {/* Center */}
  <Space>
    <Button>Help</Button>
    <Button type="primary">Save</Button>
  </Space>
...
<Layout.Footer invertOrder>
  ...
  <Text preset="t4" color="#dark-03">Draft saved</Text>
</Layout.Footer>
```
...
<Layout height="400px">
  ...
  <Layout flow="row">                    {/* Horizontal flex */}
    ...
    <Layout>                             {/* Nested layout */}
      ...
      <Layout.Content>Inner content</Layout.Content>
    </Layout>
  </Layout>
</Layout>
```
