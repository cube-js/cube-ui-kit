...
- Resize handlers can be focused but require pointer interaction
...
- **Keyboard resize support**: Allow panel resizing via keyboard arrows when handler is focused
...
- **Panel persistence**: Built-in localStorage support for remembering panel sizes and open states
