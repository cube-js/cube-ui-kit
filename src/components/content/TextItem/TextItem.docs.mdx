...
Supports [Base properties](/docs/getting-started-base-properties--docs) and all [Text](/docs/generic-text--docs) properties including `preset`, `color`, `weight`, `transform`, `ellipsis`, `nowrap`.
