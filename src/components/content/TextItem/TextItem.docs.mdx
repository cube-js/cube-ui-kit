...
Supports [Base properties](/docs/base-properties--docs) and all [Text](/docs/generic-text--docs) properties including `preset`, `color`, `weight`, `transform`, `ellipsis`, `nowrap`.
