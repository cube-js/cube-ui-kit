...
Supports [Base properties](https://github.com/tenphi/tasty/blob/main/docs/tasty.md) and all [Text](/docs/generic-text--docs) properties including `preset`, `color`, `weight`, `transform`, `ellipsis`, `nowrap`.
...
- [Text](/docs/generic-text--docs) - Base text component without overflow handling
