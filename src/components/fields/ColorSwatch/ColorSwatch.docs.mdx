...
A square of color. It is the smallest piece of the color family — [ColorPicker](/docs/forms-colorpicker--docs), [ColorInput](/docs/forms-colorinput--docs) and [ColorSwatchGroup](/docs/forms-colorswatchgroup--docs) all draw one, and it is exported so a legend, a list row or a table cell can draw the same one.
