...
- [Checkbox](/components/Checkbox) - For selection that doesn't take immediate effect
- [RadioGroup](/components/RadioGroup) - For selecting one option from multiple choices
- [Button](/components/Button) - For actions that require confirmation
