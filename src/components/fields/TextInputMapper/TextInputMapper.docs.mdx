...
<Canvas of={TextInputMapperStories.WithLabel} />

### With Default Value

<Canvas of={TextInputMapperStories.WithDefaultValue} />

### Disabled State

<Canvas of={TextInputMapperStories.Disabled} />

### Custom Components

<Canvas of={TextInputMapperStories.CustomComponents} />
