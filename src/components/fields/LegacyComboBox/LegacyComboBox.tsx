...
export interface CubeLegacyComboBoxProps<T>
  extends Omit<
...
export const LegacyComboBox = forwardRef(function LegacyComboBox<
  T extends object,
>(props: CubeLegacyComboBoxProps<T>, ref: ForwardedRef<HTMLDivElement>) {
  ...
  let comboBoxField = (
    <LegacyComboBoxWrapperElement
      ref={wrapperRef}
      qa={qa || 'LegacyComboBox'}
      mods={mods}
  ...
  return wrapWithField<Omit<CubeLegacyComboBoxProps<T>, 'children'>>(
    comboBoxField,
    ref,
