...
- **`emptyLabel`** `ReactNode` — Label shown when filtering yields no results. When provided, the popover stays open and displays this message; when omitted, the popover closes
...
<Story of={ComboBoxStories.CustomEmptyState} />
