...
const BODY_STYLES: { [key: string]: string } = {
...
function buildTokensCSS(applyLegacyTokens: boolean): string {
  if (!applyLegacyTokens) return '';
...
function buildBodyStylesCSS(bodyStyles?: { [key: string]: string }): string {
