...
Creates a form instance for programmatic control. See [FormInstance documentation](/docs/forminstance) for detailed API.
...
- [FormInstance](/docs/forminstance) - Programmatic form control API
- [Input.Text](/docs/input-text) - Text input field
- [Input.Password](/docs/input-password) - Password input field
- [Select](/docs/select) - Dropdown selection field
- [Checkbox](/docs/checkbox) - Checkbox input field
- [Field](/docs/field) - Field wrapper (deprecated for regular use)
- [DialogForm](/docs/dialog-form) - Form within a dialog
