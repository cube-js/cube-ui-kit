...
Individual menu items. Each item is rendered using [Item](/docs/content-item--docs) and supports all Item properties for layout, icons, descriptions, and interactive features.
