...
- [Button](/docs/components-actions-button--docs) - Primary use case for tooltips
- [IconButton](/docs/components-actions-iconbutton--docs) - Often paired with tooltips for clarity
- [Link](/docs/components-actions-link--docs) - Can use tooltips for additional context
- [Popover](/docs/components-overlays-popover--docs) - For more complex interactive content
